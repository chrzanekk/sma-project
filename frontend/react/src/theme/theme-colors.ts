...
export const themeColors = {
    bgColorPrimary: () => useColorModeValue('gray.50', 'gray.700'),
    bgColorSecondary: () => useColorModeValue('gray.200', 'gray.600'),
    buttonBgColor: () => useColorModeValue('gray.200', 'gray.600'),
...
export const themeColorsHex = {
    ...
    bgColorSecondary: () => useColorModeValue('#e4e4e7', '#52525b'), // 'gray.200', 'gray.600'
    popoverBgColor: () => useColorModeValue('#FFFFFF', '#e4e4e7'), // white | gray.200
    fontColor: () => useColorModeValue('#52525b', '#d4d4d8'), // gray.600 | gray.300
