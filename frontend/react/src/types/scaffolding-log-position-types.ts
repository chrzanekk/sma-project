import {DimensionType} from "@/types/enums/dimension-types-enum.ts";
import {ScaffoldingOperationType} from "@/types/enums/scaffolding-operation-types-enum.ts";
import {UnitBaseDTO} from "@/types/unit-types.ts";
import {CompanyBaseDTO} from "@/types/company-types.ts";
import {ScaffoldingType} from "@/types/enums/scaffolding-type-types-enum.ts";
import {TechnicalProtocolStatus} from "@/types/enums/technical-protocol-status-types-enum.ts";
