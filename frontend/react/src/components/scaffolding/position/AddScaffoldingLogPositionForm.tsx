...
const AddScaffoldingLogPositionForm: React.FC<AddScaffoldingLogPositionFormProps> = ({
    ...
    const initialValues: BaseScaffoldingLogPositionFormValues = {
        ...
        scaffoldingPartialDimension: "",
        scaffoldingPartialDimensionUnit: null as any,
        fullWorkingTime: "",
        partialWorkingTime: "",
        ...
        contractor: parentPosition?.contractor || undefined,
        contractorContact: parentPosition?.contractorContact || undefined,
        scaffoldingUser: parentPosition?.scaffoldingUser || undefined,
        scaffoldingUserContact: parentPosition?.scaffoldingUserContact || undefined,
        childPositions: [],
        dimensions: [],
        workingTimes: []
    }
