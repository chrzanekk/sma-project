...
CREATE INDEX idx_scaffolding_log_name ON scaffolding_log(name);
...
-- COMMENTS
-- =============================================================================
COMMENT ON TABLE work_type IS 'Stores work type definitions for scaffolding operations';
...
COMMENT ON TABLE scaffolding_log IS 'Main scaffolding log table linked to construction sites';
...
COMMENT ON TABLE scaffolding_log_position IS 'Individual scaffolding positions within a log';
...
COMMENT ON TABLE scaffolding_log_position_working_time IS 'Working time records for scaffolding positions';
...
COMMENT ON TABLE scaffolding_log_position_dimensions IS 'Dimension records for scaffolding positions - multiple dimensions per position';
